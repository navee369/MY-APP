...
import {create} from './postdata.js'
...
class NewPost extends Component {
  ...
  render() {
    ...
    return (<div className={classes.root}>
      ...
      <CardActions>
        <Button color="secondary" variant="raised" disabled={this.state.text === ''} onClick={this.clickPost} className={classes.submit}>POST</Button>
      </CardActions>
    </Card>
  </div>)
  }
