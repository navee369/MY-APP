...
import {read, update} from './user.js'
    ...
    return (
      <Card className={classes.card}>
        <CardContent>
          ...
          <input accept="image/*" onChange={this.handleChange('photo')} className={classes.input} id="icon-button-file" type="file" />
          <label htmlFor="icon-button-file">
          <IconButton color="primary" className={classes.photoButton} component="span">
            <PhotoCamera />
          </IconButton>
        ...
        <CardActions>
          <Button style ={{color : blue100}} variant="raised" onClick={this.clickSubmit} className={classes.submit}>Submit</Button>
        </CardActions>
      </Card>
    )
  }
