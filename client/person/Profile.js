...
import DeleteUser from './accountdelete'
import auth from './../isAuthenticate/help'
import {read} from './user.js'
import {Redirect, Link} from 'react-router-dom'
import ProfileTabs from './../person/ProfileTabs'
import {listByUser} from './../mypost/postdata.js'
        ...
        <List dense>
          <ListItem>
            ...
            <ListItemText primary={this.state.user.name} secondary={this.state.user.email}/> 
              if(auth.isAuthenticated().user._id === this.state.user._id){
